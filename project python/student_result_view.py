...
class StudentResultClass:
    def __init__(self, root ):
        ...
        # title 
        title= Label(self.root, text="VIEW   RESULT",compound=LEFT,font=("Aerial Black",20,"bold"),bg="orange").place(x=0,y=0,relwidth=1,height=50)
